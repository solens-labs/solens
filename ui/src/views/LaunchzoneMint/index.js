...
export default function LaunchzoneMint(props) {
    ...
    const mintOne = async (candyMachineID) => {
        ...
        try {
            ...
            let final_tx ;
            if (candyMachineState.data.whitelistMintSettings) {
                const wlMint = new anchor.web3.PublicKey(
                    candyMachine.data.whitelistMintSettings.mint,
                );
                let wlTokenAccounts = await connection.getTokenAccountsByOwner(payer, {mint: wlMint})
                for (let i = 0; i < wlTokenAccounts.lenght; i++) {
                    let bal = await connection.getTokenAccountBalance(wlTokenAccounts[i])
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <div
                        className="minting_stats d-flex flex-wrap justify-content-around col-12 mt-0 mb-4">
            ...
            <div
                className="minting_module chartbox d-flex flex-column align-items-center flex-wrap col-12 col-lg-10 col-xxl-8 mb-3 mb-lg-5 pb-3 pt-3 p-0">
                <div
                    className="minting_title col-12 d-flex flex-column align-items-center">
                    {!released && (
                        <>
                ...
                <div
                    className="minting_progress col-12 d-flex flex-column align-items-center">
                    ...
                    <h4 className="col-10 col-xl-6 mb-4">
                        Items
                        Minted: {itemsMinted?.toFixed(0).toLocaleString() || 0} /{" "}
              ...
              {`(${Math.floor(mintProgress)}%)`}
                ...
                <div
                    className="minting_buttons col-12 d-flex flex-column align-items-center">
                    ...
                    {txHash && (
                        <div
                            className="d-flex flex-row col-9 col-md-7 col-lg-5 col-xl-4 col-xxl-3 justify-content-around">
                            <a
