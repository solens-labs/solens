...
export default function LaunchzoneMint(props) {
    ...
    const mintOne = async () => {
        ...
        try {
          ...
          console.log('price in sol ', candyMachineState.data.price.toNumber())
          console.log('items available ',candyMachineState.data.itemsAvailable.toNumber())
          console.log('items redeemed ',candyMachineState.itemsRedeemed.toNumber())
          console.log('goLiveDate: ',candyMachineState.data.goLiveDate
          ? //@ts-ignore
            new Date(candyMachineState.data.goLiveDate * 1000)
          : 'N/A')
    ...
    return (
        <div
            className="collection_launch d-flex flex-column align-items-center col-12 mt-4 mt-lg-5">
            {collectionInfo?.name && (
                <Helmet>
            ...
            <div
                className="collection_details d-flex flex-wrap col-12 col-lg-10 col-xxl-8 mb-3">
                <div
                    ...
                    {collectionInfo?.image ? (
                        ...
                        <div
                            className="collection_image_large d-flex justify-content-center overflow-hidden">
                            <Loader/>
                        </div>
                    )}
                </div>
                <div
                    className="collection_heading col-12 col-lg-7 d-flex flex-column align-items-center justify-content-around">
                    ...
                    <div
                        className="minting_stats d-flex flex-wrap justify-content-around col-12 mt-4 mb-4">
                        <MintingStat
                        ...
                        <MintingStat
                            ...
                            label={"Items"}
                        />
                        <MintingStat stat={collectionInfo?.price + " ◎"}
                                     label={"Price"}/>
                    </div>
            ...
            <div
                className="minting_module chartbox d-flex flex-column align-items-center justify-content-between flex-wrap col-12 col-lg-10 col-xxl-8 mb-3 mb-lg-5 pb-3 pt-3">
                <div
                    className="minting_title col-12 d-flex flex-column align-items-center justify-content-center">
                    {!released && (
                        <>
                ...
                <div
                    className="minting_progress col-12 d-flex flex-column align-items-center justify-content-center">
                ...
                <div
                    className="minting_buttons col-12 d-flex flex-column align-items-center justify-content-center">
                    ...
                    {wallet.connected && !released && (
                        <button className="btn_outline_outer">
                            <div className="btn_outline_inner">Launching Soon
                            </div>
                        </button>
                    )}
                    ...
                    {ended && (
                        <button
                            className="btn-button connect_button">Ended</button>
                    )}
                </div>
            </div>
        </div>
